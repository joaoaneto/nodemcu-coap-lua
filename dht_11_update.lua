...
-- Updated for better adaptation with json encode.
-- For this, it return a table.  
-- 2017 - joaoaneto
...
function getTemp()
    ...
    data['temperature'] = Temperature.."."..TemperatureDec 
    data['humidity'] = Humidity.."."..HumidityDec
